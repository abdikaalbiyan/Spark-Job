...
def main():
    ...
    data1 = pd.read_json('gs://week3-spark-etl/json-files/2019-05-04.json', lines=True)
    data1.drop('id', inplace=True, axis=1)
    data1.loc[data1['flight_date'] == '2019-05-04', 'flight_date'] = '2021-04-26'

    data2 = pd.read_json('gs://week3-spark-etl/json-files/2019-05-05.json', lines=True)
    data2.drop('id', inplace=True, axis=1)
    data2.loc[data2['flight_date'] == '2019-05-05', 'flight_date'] = '2021-04-27'

    data3 = pd.read_json('gs://week3-spark-etl/json-files/2019-05-06.json', lines=True)
    data3.drop('id', inplace=True, axis=1)
    data3.loc[data3['flight_date'] == '2019-05-06', 'flight_date'] = '2021-04-28'

    data4 = pd.read_json('gs://week3-spark-etl/json-files/2019-05-07.json', lines=True)
